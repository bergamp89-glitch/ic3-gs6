          ...
          {cameraStatus !== 'no-camera' && cameraStatus !== 'denied' && (
            <div className="flex flex-col items-center w-full">
              ...
              <div className="mt-3 text-center px-4 min-h-[38px] w-full">
                ...
                {/* Liveness Anti-Spoofing Indicator */}
                <div className="flex items-center justify-center gap-1.5 mb-1">
                  {livenessVerified ? (
                    <span className="inline-flex items-center gap-1 bg-emerald-100 text-emerald-800 text-[10px] font-bold px-2 py-0.5 rounded-full border border-emerald-300">
                      <svg className="w-3 h-3 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 13l4 4L19 7"></path></svg>
                      Jonli inson tasdiqlandi (Anti-Spoofing ✓)
                    </span>
                  ) : detection.detected && detection.quality === 'good' ? (
                    <span className="inline-flex items-center gap-1 bg-cyan-100 text-cyan-800 text-[10px] font-bold px-2 py-0.5 rounded-full border border-cyan-300 animate-pulse">
                      ...
                      Ko'zingizni bir marta pirpirating (yumib-oching)
                    </span>
                  ) : null}
                </div>
                      ...
                      <>
                        <div className={`w-full py-2.5 px-3 rounded-xl text-xs font-semibold text-center border transition-all ${
                          ...
                          {isScanning 
                            ...
                            : livenessVerified
                            ? "Jonli yuz tasdiqlandi ✓ Suratga olinmoqda..."
                            : detection.detected && detection.quality === 'good'
                            ? "Yuz aniqlandi ✓ Ko'zingizni pirpirating..."
                        ...
                        {detection.detected && detection.quality === 'good' && !isScanning && (
                          <button
                            ...
                            className="text-[11px] font-bold text-[#1a446b] hover:text-emerald-700 bg-slate-100 hover:bg-slate-200 border border-slate-300 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1.5"
                          >
